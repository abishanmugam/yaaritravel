    ...
    return (
      showViewProductButton && (
        <Link to={`/product/${product._id}`} className="mr-2">
          <button
            className="btn btn-info mt-2 mb-2 card-btn-1"
            id="view-product"
          >
            More Info!
          </button>
    ...
    <div className="border rounded shadow">
      <div className="card m-2 ">
        <div className="view overlay">
          ...
          <h5 className="ml-2 text-success h5 font-weight-bold pb-2">
            {product.name}
          </h5>
        </div>
        <div class="card-body m-0 p-0">
          <div className="d-flex justify-content-between mx-2 mb-0">
            <h6
              ...
              style={{ fontWeight: '600', fontSize: '0.8em', color: '#eb07c1' }}
            >
              {product.subname}
            </h6>
            <StarRating />
          ...
          <div className="mt-2 px-3">
            <p className="badge badge-warning badge-pill shadow">
              Price : ₹ {product.price}
            </p>
          </div>
        </div>

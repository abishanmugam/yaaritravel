              ...
              <div className="card m-2 ">
                ...
                <div class="card-body m-0 p-0">
                  <p className="text-justify p-3">
                    TravelYaari is an Indian Tourism website created by
                    university Students. It is the design to get place in the
                    top tourism website in India. Travelyaari started as a mini
                    project, but intended to become a major project. TravelYaari
                    will provide many tourism packages in upcoming years.
                    TravelYaari aim to have a website with different language
                    support for different regions of the country and also
                    allowing booking to places of different countries also. Most
                    travel websites charges international charges for certain
                    booking when opting internationally, but we aim to provide
                    booking free of any international charges across the globe
                    without a single penny. We also aim to have branches in many
                    countries and we shall provide facility of user interest as
                    per their needs. We aim to deal with the best hotels ,
                    motels and lauge, so we provide quality services to our
                    costumers.
                  </p>
                </div>
              </div>
            ...
            <div className="border rounded shadow">
              <div className="card m-2 ">
                ...
                <div class="card-body m-0 p-0 mt-2">
                  ...
                  <p className="text-justify p-3">
                    TravelYaari website is created by Sarvesh Kumar Sharma,
                    Satyam Jha and Sachi Tripathi (Students at Gla
                    ...
                    <br />
                    In the december 2020, TravelYaari website get Deployed to
                    ...
                    <br />
                    In the April 2021, TravelYaari website get itself developed
                    by MERN Stack & Deployed to various platform.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card m-2 ">
                ...
                <div class="card-body m-0 p-0">
                  <ul className="list-group">
                    <li className="list-group-item text-info h6 font-weight-bold">
